...
[BepInAutoPlugin("com.discussions.VentLib3D")]
...
public partial class Vents : BasePlugin
{
    ...
    internal static readonly Dictionary<uint, NetworkedLocomotionPlayer> LastSenders = new();

    internal static Vents Instance = null!;
    ...
    public static void Initialize()
    {
        ...
        NoDepLogger.High($"Initializing VentFramework 3D {Assembly.GetExecutingAssembly().GetName().Version!.ToString(4)}");
